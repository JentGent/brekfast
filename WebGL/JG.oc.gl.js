...
var gl, glPrograms = [], activeProgram;
...
Program.prototype.injectTexture = function(n, i, w, h, a, ws, wt, mf, Mf) {
    ...
    gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, mf || gl.NEAREST_MIPMAP_LINEAR);
    ...
    this.setUniform(this.program, n, "1iv", [i]);
    return tex;
...
var universalUniform = function(n, t, v) {
    for(var i = 0; i < glPrograms.length; i += 1) {
        glPrograms[i].setUniform(n, t, v);
    }
};
